...
async def start_bot(event):
    ...
    3️⃣ **تشغيل الصوت في المحادثة الصوتية**: قم بالرد على الملف الصوتي الذي أرسلنه واستخدم `/شغل` لتشغيله.
...
@client.on(events.NewMessage(func=lambda e: e.file and getattr(e.file, 'name', None) and (e.file.name.endswith('.mp3') or e.file.name.endswith('.ogg'))))
